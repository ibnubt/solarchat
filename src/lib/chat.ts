...
export const CHAT_MODELS: ModelOption[] = [
  { value: 'gpt-5.6-luna', label: 'GPT-5.6 Luna', multimodal: true, cost: '$0.07 / $0.42' },
  { value: 'gemini-2.5-flash-lite', label: 'Gemini 2.5 Flash Lite', multimodal: true, cost: '$0.08 / $0.32' },
  { value: 'gemini-2.5-flash', label: 'Gemini 2.5 Flash', multimodal: true, cost: '$0.24 / $2.00' },
  { value: 'deepseek-v4-1-flash', label: 'DeepSeek V4.1 Flash', multimodal: false, cost: '$0.02 / $0.90' },
  { value: 'deepseek-v4-flash', label: 'DeepSeek V4 Flash', multimodal: false, cost: '$0.17 / $0.50' },
  { value: 'glm-5.3-flash', label: 'GLM-5.3 Flash', multimodal: false, cost: '$0.03 / $0.09' },
  { value: 'gpt-oss-120b', label: 'GPT OSS 120B', multimodal: false, cost: '$0.14 / $0.72' },
  { value: 'doubao-seed-2-0-mini-260428', label: 'Doubao Seed 2.0 Mini', multimodal: false, cost: '$0.03 / $0.30' }
];
